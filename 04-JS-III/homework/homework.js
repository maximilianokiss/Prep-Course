...
function promedioResultadosTest(resultadosTest) {
  ...
  var pro = acu / resultadosTest.length;
  return pro
}
...
function cuentoElementos(arreglo) {
  ...
  //Escribe tu código aquí
  var resultado = arreglo.filter((e) => {
    return e > 18
  })
...
function mayorACien(array) {
  ...
  // Tu código:
  var nuevoArray = array.filter(el => {
    return el > 100
  })
  return nuevoArray;
}
...
function breakStatement(numero) {
  ...
  if (index < 10) return "Se interrumpió la ejecución";
  return arr
}
