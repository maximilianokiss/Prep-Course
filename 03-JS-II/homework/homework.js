...
function esEntero(numero) {
  ...
  // Tu código:
  if (numero.toString().includes(".")) return false;
  else return true;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  if (num3 > num1 && num3 > num2 && num1 > 0) return num3 + 1;
  if (num1 > num2 && num1 > num2 && num1 > 0) return "Número 1 es mayor y positivo";
  return false;
}
